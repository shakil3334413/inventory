<template>
    <div class="row justify-content-center">
        <div class="col-xl-12 col-lg-12 col-md-12">
             <router-link to="/employeecreate" class="btn btn-success">Employee Create</router-link>
                                        ...
                                        <tbody>
                                            <tr v-for="employee in filterSearch" :key="employee.id">
                                                ...
                                                <td style="display: flex;">
                                                    <router-link :to="{ name: 'EmployeeEdit', params: { id: employee.id }}" class="btn btn-info btn-sm m-1">Edit</router-link>
                                                    <a @click="employeeDelete(employee.id)" class="btn btn-danger btn-sm m-1">Delete</a>
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
